 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".estimation__slider")) new core(".estimation__slider", {
                ...
                navigation: {
                    prevEl: ".estimation-button-prev",
                    nextEl: ".estimation-button-next"
                },
                on: {}
            });
                ...
                on: {
                    init: function(swiper) {
                        setTimeout((() => {
                            ...
                            document.querySelector(".fraction-controll__current").textContent = currentSlide < 10 ? `0${currentSlide}` : currentSlide;
                            document.querySelector(".fraction-controll__all").textContent = totalSlides < 10 ? `0${totalSlides}` : totalSlides;
                            toggleSwiperControls(swiper.isEnd);
                        }), 100);
                    },
            ...
            if (document.querySelector(".worker__slider")) new core(".worker__slider", {
        ...
        function toggleSwiperControls(hide) {
            const elements = [ document.getElementById("calc"), document.querySelector(".calculator__pagination") ];
            elements.forEach((el => {
...
***************************************************************************** */
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            const rangeSliders = document.querySelectorAll(".rs-range");
            rangeSliders.forEach((function(rangeSlider) {
                const rangeBullet = rangeSlider.previousElementSibling;
                updateSlider(rangeSlider, rangeBullet);
                rangeSlider.addEventListener("input", (function() {
                    requestAnimationFrame((() => {
                        updateSlider(rangeSlider, rangeBullet);
                    }));
                }));
                function updateSlider(slider, bullet) {
